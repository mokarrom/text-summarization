...
# Invoke Chapter Summarization SageMaker Endpoint
...
[This script](https://github.com/jasperdew/chapter_summarization_api/blob/develop/src/summarizer/scripts/invoke_endpoint_async.py) depicts how to use Chapter Summarizer SageMaker Endpoint from Python. For more information or call the endpoint from AWS CLI or another language, please check [here](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_runtime_InvokeEndpoint.html)

## Endpoint Details
- Name: gpt-book-sum-endpoint
- ARN: arn:aws:sagemaker:eu-central-1:957269117416:endpoint/gpt-book-sum-endpoint
- URL: https://runtime.sagemaker.eu-central-1.amazonaws.com/endpoints/gpt-book-sum-endpoint/invocations

## Prerequisite
Your execution role needs function permission to invoke a SageMaker endpoint. Make sure you have the below policy attach to your execution role.
```json
{
    "Version": "2012-10-17",
    "Statement": [
...
### Request Body:
The request body must contain `chapters` field which is a sequence of chapters. Each chapter must contain two fields `id` and `text` 
where `id` is an integer which must be unique within a book and `text` is the text (_UTF-8_) of that chapter.
...
```json
{
  ...
  "book_id": "book name or document id used for debugging"
}
```
...
```json
{
  "intro": "This is the introduction of the book.",
  "summary": "This is the summary of the book.",
  "conclusion": "This is the conclusion of the book.",
  "book_id": "book name or document id used for debugging"
}
```
